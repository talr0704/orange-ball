...
lib.ssMetadata = [
		{name:"אקשן סקריפט_HTML5 Canvas_atlas_1", frames: [[0,930,1397,758],[0,0,1827,928]]},
		{name:"אקשן סקריפט_HTML5 Canvas_atlas_2", frames: [[0,0,1384,751],[0,753,1384,751]]},
		{name:"אקשן סקריפט_HTML5 Canvas_atlas_3", frames: [[0,753,1378,676],[0,0,1384,751]]},
		{name:"אקשן סקריפט_HTML5 Canvas_atlas_4", frames: [[0,678,1375,601],[0,0,1378,676],[0,1281,1375,601]]},
		{name:"אקשן סקריפט_HTML5 Canvas_atlas_5", frames: [[0,681,1373,527],[0,1210,1373,527],[0,0,1143,679]]},
		{name:"אקשן סקריפט_HTML5 Canvas_atlas_6", frames: [[0,1328,1368,377],[0,420,1370,452],[0,874,1370,452],[0,0,1623,418]]},
		{name:"אקשן סקריפט_HTML5 Canvas_atlas_7", frames: [[0,379,1366,303],[0,0,1368,377],[0,684,1366,303],[0,989,909,418],[911,989,728,433],[0,1409,728,433],[730,1424,728,433]]},
		{name:"אקשן סקריפט_HTML5 Canvas_atlas_8", frames: [[1732,0,303,342],[1688,772,297,341],[1631,1115,297,341],[1631,1458,297,341],[527,1296,382,266],[0,1098,374,293],[1363,742,323,354],[723,1564,238,426],[0,1591,239,426],[911,1098,238,426],[241,1591,239,426],[482,1591,239,426],[963,1526,238,426],[1151,1098,238,426],[1203,1526,238,426],[1391,1098,238,426],[1732,344,239,426],[0,772,1358,80],[0,460,1361,154],[0,0,1363,228],[0,230,1363,228],[0,616,1361,154],[0,854,1358,80],[1365,0,365,369],[1365,371,365,369],[0,1393,525,196],[1443,1801,525,191],[376,1098,525,196]]},
		{name:"אקשן סקריפט_HTML5 Canvas_atlas_9", frames: [[835,0,302,312],[1731,423,254,232],[212,552,254,232],[835,412,387,219],[1139,0,386,244],[0,257,210,404],[1694,0,202,421],[387,0,223,428],[612,0,221,428],[468,552,254,232],[0,0,385,255],[724,667,528,106],[1224,423,505,120],[212,430,505,120],[1254,667,528,106],[1139,246,553,164],[1224,545,505,120]]}
];
...
(lib.CachedBmp_74 = function() {
	this.initialize(ss["אקשן סקריפט_HTML5 Canvas_atlas_8"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_73 = function() {
	this.initialize(ss["אקשן סקריפט_HTML5 Canvas_atlas_9"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_45 = function() {
	this.initialize(ss["אקשן סקריפט_HTML5 Canvas_atlas_7"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_44 = function() {
	this.initialize(ss["אקשן סקריפט_HTML5 Canvas_atlas_6"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_42 = function() {
	this.initialize(ss["אקשן סקריפט_HTML5 Canvas_atlas_5"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_41 = function() {
	this.initialize(ss["אקשן סקריפט_HTML5 Canvas_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_40 = function() {
	this.initialize(ss["אקשן סקריפט_HTML5 Canvas_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_39 = function() {
	this.initialize(ss["אקשן סקריפט_HTML5 Canvas_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.CachedBmp_38 = function() {
	this.initialize(ss["אקשן סקריפט_HTML5 Canvas_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.אקשןסקריפט_HTML5Canvas = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_21.png?1650362794796", id:"CachedBmp_21"},
		{src:"images/CachedBmp_2.png?1650362794796", id:"CachedBmp_2"},
		{src:"images/CachedBmp_1.png?1650362794796", id:"CachedBmp_1"},
		{src:"images/אקשן סקריפט_HTML5 Canvas_atlas_1.png?1650362794692", id:"אקשן סקריפט_HTML5 Canvas_atlas_1"},
		{src:"images/אקשן סקריפט_HTML5 Canvas_atlas_2.png?1650362794692", id:"אקשן סקריפט_HTML5 Canvas_atlas_2"},
		{src:"images/אקשן סקריפט_HTML5 Canvas_atlas_3.png?1650362794692", id:"אקשן סקריפט_HTML5 Canvas_atlas_3"},
		{src:"images/אקשן סקריפט_HTML5 Canvas_atlas_4.png?1650362794692", id:"אקשן סקריפט_HTML5 Canvas_atlas_4"},
		{src:"images/אקשן סקריפט_HTML5 Canvas_atlas_5.png?1650362794692", id:"אקשן סקריפט_HTML5 Canvas_atlas_5"},
		{src:"images/אקשן סקריפט_HTML5 Canvas_atlas_6.png?1650362794692", id:"אקשן סקריפט_HTML5 Canvas_atlas_6"},
		{src:"images/אקשן סקריפט_HTML5 Canvas_atlas_7.png?1650362794692", id:"אקשן סקריפט_HTML5 Canvas_atlas_7"},
		{src:"images/אקשן סקריפט_HTML5 Canvas_atlas_8.png?1650362794693", id:"אקשן סקריפט_HTML5 Canvas_atlas_8"},
		{src:"images/אקשן סקריפט_HTML5 Canvas_atlas_9.png?1650362794693", id:"אקשן סקריפט_HTML5 Canvas_atlas_9"},
		{src:"sounds/Flutemagicaltransiotion.mp3?1650362794796", id:"Flutemagicaltransiotion"},
		{src:"sounds/Glassbreakingsound.mp3?1650362794796", id:"Glassbreakingsound"},
		{src:"sounds/Snowballhitsoundeffect.mp3?1650362794796", id:"Snowballhitsoundeffect"},
		{src:"sounds/TVstaticnoise.mp3?1650362794796", id:"TVstaticnoise"},
		{src:"sounds/Tvturnoffsoundeffect.mp3?1650362794796", id:"Tvturnoffsoundeffect"}
	],
	preloads: []
};
